...
const Typo = () => {
  return (<div>
    ...
    <div style={style}>
      ...
      <Typography variant="display4" gutterBottom="gutterBottom">
        Display 4
      </Typography>
      <Typography variant="display3" gutterBottom="gutterBottom">
        Display 3
      </Typography>
      <Typography variant="display2" gutterBottom="gutterBottom">
        Display 2
      </Typography>
      <Typography variant="display1" gutterBottom="gutterBottom">
        Display 1
      </Typography>
      ...
      <Typography variant="subheading" gutterBottom="gutterBottom">
        Subheading
      </Typography>
      <Typography variant="body2" gutterBottom="gutterBottom">
        Body 2
      </Typography>
      <Typography variant="body1" gutterBottom="gutterBottom" align="right">
        Body 1
      </Typography>
      <Typography variant="caption" gutterBottom="gutterBottom" align="center">
        Caption
      </Typography>
      <Typography gutterBottom="gutterBottom" noWrap="noWrap">
        {
          `
      ...
      <Typography variant="button" gutterBottom="gutterBottom">
        Button
      </Typography>
    </div>
